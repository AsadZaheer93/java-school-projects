package GA3;
/*
 * Program Name: GA3.java
 * @author Asad Zaheer
 * @date 10 May 2020
 * 
 * Module 5.2 - Guided Assignment 3: Lazy size (0.5 points)
 * Read Tries section: 
 * Size  (page 736)
 * CODE: Lazy recursive size() for tries (page 736)
 * Implement and test
 * CODE: Lazy recursive size() for tries in TrieST class (page 736)
 * Update the test class and test size method for 5 different tries.
 */
public class GA3 {
	public static void main(String args[]) {
		...
		StdOut.println("Lazy Recursive Size: "+trie1.size());
		StdOut.println();
		...
		StdOut.println("Lazy Recursive Size: "+trie2.size());
		StdOut.println();
		...
		StdOut.println("Lazy Recursive Size: "+trie3.size());
		StdOut.println();
		...
		StdOut.println("Lazy Recursive Size: "+trie4.size());
		StdOut.println();
		...
		StdOut.println("Lazy Recursive Size: "+trie5.size());
		StdOut.println();
