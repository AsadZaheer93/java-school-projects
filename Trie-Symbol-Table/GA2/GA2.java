package GA2;
/*
 * Program Name: GA2.java
 * @author Asad Zaheer
 * @date 10 May 2020
 * 
 * Module 5.2 - Guided Assignment 2: Trie Symbol Table representation (0.5 points)
 * Read Tries section: 
 * Node representation  (page 734-736)
 * Algorithm 5.4 Trie symbol table (page 737)
 * Implement and test
 * Algorithm 5.4 Trie symbol table (page 737)
 * Create a test class and test each method with 5 inputs.
 */
public class GA2 {
	public static void main(String args[]) {
		...
		StdOut.println("5th value: " + trie1.get("Node5").getVal());
		StdOut.println();
		...
		StdOut.println("3rd value: " + trie2.get("CFXPFIY").getVal());
		StdOut.println();
		...
		StdOut.println("1st value: " + trie3.get("58Y998Y").getVal());
		StdOut.println();
		...
		StdOut.println("4th value: " + trie4.get("LCFIGVT").getVal());
		StdOut.println();
		...
		StdOut.println("2nd value: " + trie5.get("3RD6RR1RGV").getVal());
		StdOut.println();
